...
export default {
    ...
    methods: {
        ...
        makeAppointment() {
            if(this.newAppointment.date){
                ...
                if(this.getStatusForTimeslot(this.newAppointment.timeslot)=='Not Full'){
                    ...
                    axios.post('/doctor/appointments/add', input).then((response)=>{
        ...
        getCountStatus() {
            ...
            axios.get('/doctor/appointments/count/'+date).then( (response)=>{
        ...
        checkPatientID(){
            ...
            if(this.newAppointment.patient_id){
                axios.get('/doctor/appointments/checkid', {params: {patient_id: this.newAppointment.patient_id}}).then( (response)=>{
        ...
        checkAppointment(){
            // console.log(this.newAppointment.patient_id);
                let date=this.formatDate(this.newAppointment.date);
                axios.get('/doctor/appointments/checkappointment', {params: {date:date,patient_id: this.newAppointment.patient_id}}).then( (response)=>{
                    //console.log(response.data);
                    if(response.data==0){
        ...
        getAppointmentforDate(){
            if(this.newAppointment.date){
                ...
                axios.get('/doctor/appointments/showfordate', {params: {date: date}}).then( (response)=>{
        ...
        getAppointments($timeslot){
            if(this.newAppointment.date){
                ...
                axios.get('/doctor/appointments/show', {params: {date: date,timeslot:$timeslot}}).then( (response)=>{
                    this.appointments = response.data;
                    console.log(response.data);
                })
            }else{
        ...
        cancelAppointment(appointment){
                ...
                axios.post('/doctor/appointments/cancel', {date: date,patient_id: appointment.patient_id}).then( (response)=>{
