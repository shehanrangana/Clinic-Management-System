            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <date-picker @change="getCountStatus(); getAppointmentforDate();" :lang="lang" name="date" id="date" :required="true" v-model="newAppointment.date"></date-picker>
                    </div>  
                </div>
                <div class="col">   
                </div>
...
export default {
    ...
    methods: {
        ...
        getCountStatus() {
            ...
            axios.get('/nurse/make_appointment/count/'+date).then( (response)=>{
        ...
        checkPatientID(){
            ...
            if(this.newAppointment.patient_id){
                axios.get('/nurse/make_appointment/checkid', {params: {patient_id: this.newAppointment.patient_id}}).then( (response)=>{
        ...
        checkAppointment(){
            // console.log(this.newAppointment.patient_id);
                let date=this.formatDate(this.newAppointment.date);
                axios.get('/nurse/make_appointment/checkappointment', {params: {date:date,patient_id: this.newAppointment.patient_id}}).then( (response)=>{
                    //console.log(response.data);
                    if(response.data==0){
        ...
        getAppointmentforDate(){
            if(this.newAppointment.date){
                ...
                axios.get('/nurse/make_appointment/showfordate', {params: {date: date}}).then( (response)=>{
        ...
        getAppointments($timeslot){
            if(this.newAppointment.date){
                ...
                axios.get('/nurse/make_appointment/show', {params: {date: date,timeslot:$timeslot}}).then( (response)=>{
                    this.appointments = response.data;
                    console.log(response.data);
                })
            }else{
        ...
        cancelAppointment(appointment){
                ...
                axios.post('/nurse/make_appointment/cancel', {date: date,patient_id: appointment.patient_id}).then( (response)=>{
